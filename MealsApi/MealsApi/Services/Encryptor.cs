...
namespace MealsApi.Services
{
    ...
    public class Encryptor : IEncryptor
    {
        ...
        public Encryptor(IConfiguration configurationProvider)
        {
        ...
        {
            return _configurationProvider.GetConfigurationValue(ConfigurationKeys.ENCRYPT_KEY);
        }

        private string GetVector()
        {
            return _configurationProvider.GetConfigurationValue(ConfigurationKeys.ENCRYPT_VECTOR);
        }
